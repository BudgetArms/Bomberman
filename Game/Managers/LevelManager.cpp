...
#include "Commands/PlaceBombCommand.hpp"
#include "Commands/RemoteControlBombCommand.hpp"
                                                                ...
                                                                const PlayerType playerType)
{
    ...
    switch(playerType)
    {
        case PlayerType::Bomberman:
            gameObjectName = "Bomberman";
            break;
        case PlayerType::Bombermiss:
            gameObjectName = "Bombermiss";
            break;
    }
...
std::shared_ptr<bae::GameObject> LevelManager::GetEnemyBase(const glm::vec2& spawnPosition, const EnemyType enemyType)
{
    ...
    {
        case EnemyType::Balloom:
            gameObjectName = "Balloom";
            break;
        case EnemyType::Oneal:
            gameObjectName = "Oneal";
            break;
        case EnemyType::Doll:
            gameObjectName = "Doll";
            break;
        case EnemyType::Minvo:
            gameObjectName = "Minvo";
            break;
        case EnemyType::BalloomPlayer:
            gameObjectName = "Balloom Player";
            break;
    }
...
void LevelManager::AddControls(bae::GameObject& gameObject, const bool bIsFirstPlayer, const bool bIsEnemy)
{
    ...
    [[maybe_unused]] auto controllerPlacedBombCommand        = std::make_unique<PlaceBombCommand>(gameObject);
    [[maybe_unused]] auto controllerRemoteControlBombCommand = std::make_unique<RemoteControlBombCommand>(gameObject);
